...
public class SBMDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_b_m_detail);

        videoView = findViewById(R.id.mvTrailer);
        String vidPath = "android.resource://" + getPackageName() + "/" + R.raw.sbm_doraemon;
        ...
        posterTemp = storageRef.child("Movie/StandByMe.jpg");
        try {
            ...
            }).addOnFailureListener(e -> Toast.makeText(SBMDetailActivity.this, "Poster Not Found",
                    Toast.LENGTH_SHORT).show());
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        pilihJadwal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SBMDetailActivity.this, PilihJadwal.class);
